...
public class PageBase {
    ...
    private final By LOG_OUT= By.xpath("//a[normalize-space()='Log Out']");

    public PageBase clickLogOut(){
        try
        {
            shortWait(driver).until(ExpectedConditions.visibilityOfElementLocated(this.LOG_OUT));
        }
...
//wait for java script running
    ...
    public PageBase selectByVisibleText(WebElement element, String value){
